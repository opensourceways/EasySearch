...
import com.search.docsearch.common.except.BusinessException;
...
public class JacksonUtils {
    ...
    public static String toJsonTree(List<ConcurrentHashMap<String, Object>> pageMap, Object... count) {
        ...
        for (ConcurrentHashMap<String, Object> map : pageMap) {
            ...
            String key;
            Object value;
            for (Iterator<String> iterator = map.keySet().iterator(); iterator.hasNext(); tempMap.put(key.toLowerCase(),
                    value)) {
                key = iterator.next();
                value = map.get(key);
