...
import com.search.docsearch.common.utils.JacksonUtils;
...
public class GlobalExceptionHandler {
    ...
    @ResponseStatus(HttpStatus.OK)
    public void trustManagerException(HttpServletRequest request, HttpServletResponse response,
            TrustManagerException e) {
    ...
    @ResponseStatus(HttpStatus.OK)
    @ResponseBody
    public void methodArgumentNotValidException(HttpServletRequest request, HttpServletResponse response,
    ...
    @ResponseStatus(HttpStatus.OK)
    @ResponseBody
    public void illegalArgumentException(HttpServletRequest request, HttpServletResponse response,
