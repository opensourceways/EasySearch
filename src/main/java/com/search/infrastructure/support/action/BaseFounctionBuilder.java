...
public class BaseFounctionBuilder {
    @Autowired
    ...
    public void buildMustNotQuery(BoolQueryBuilder boolQueryBuilder, List limit, List filter) {
    ...
    public SearchRequest getDefaultDocsSearchRequest(SearchDocsBaseCondition condition) {
        ...
        buildShouldQuery(boolQueryBuilder, condition.getKeyword());
        buildMustNotQuery(boolQueryBuilder, null, null);
    ...
    public SearchRequest getDefaultCountSearchRequest(SearchDocsBaseCondition condition, String field, String terms) {
        ...
        this.buildMustNotQuery(boolQueryBuilder, null, null);
